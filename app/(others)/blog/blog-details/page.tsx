...
import { BUSINESS_NAME } from "@/app/(others)/config";
...
export const metadata: Metadata = {
  ...
  description:  `An awesome blog about real estate marketing, lead generation, tech, AI tools, news, step-by-step tutorials, ads and more interesting stuffs for agents`,
  // other metadata
};
...
const SingleBlogPage = async () => {
  ...
  return (
    <>
      ...
      {/* <PodcastPlayer title="Episode 2: Advanced Selling Techniques" audioFile="pay_per_closing_podcast" /> */}
          ...
          <div className="flex flex-col-reverse gap-7.5 lg:flex-row xl:gap-12.5">
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md border border-stroke bg-white p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
                ...
                <PodcastPlayer title="Episode 1: Intro to Real Estate" audioFile="pay_per_closing_podcast" />
                </div>
