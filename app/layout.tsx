...
export const metadata: Metadata = {
  title: "FleetBold - Smart Fleet Management & Vehicle Tracking",
  description: "Advanced fleet management platform for real-time vehicle tracking, GPS monitoring, and smart fleet operations. Integrate with Tesla, GPS devices, and more.",
};
